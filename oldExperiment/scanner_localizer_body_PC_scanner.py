...
while globalClock.getTime() < duration:
    ...
    for key in allKeys:
        if key == MR_settings['sync']:
            ...
            def execute_run(run, c1, c2, c3, c4, c5, c6, c7):
            ...
            #os.chdir('/Volumes/gomez/data/deaf/princetonLoc/code/experiment/shined_all')
            ...
            #blocks_runs = pd.read_csv('/Volumes/gomez/data/deaf/princetonLoc/code/experiment/blocks_runs.csv')
            ...
            #conditions = pd.read_csv('/Volumes/gomez/data/deaf/princetonLoc/code/experiment/2back_half_conditions.csv')
...
#            win = visual.Window([1920, 1080], units = 'pix', screen = 1)
            ...
            if run == 1:
                ...
                win.flip() 
                countdown()
                execute_run('run1', r1c1,r1c2,r1c3,r1c4,r1c5,r1c6,r1c7)
            elif run == 2:
                # Run 2
                message.text = ' '
                win.flip() 
